...
//--------------------------------modal dentro de card2---------------------------------------------------------//



const ventanaModal02 = document.getElementById("ventanaModal02");
const botonAbrirModal02 = document.getElementById("botonAbrirModal02");
const cerrarModal02 = document.getElementById("cerrarModal02");

botonAbrirModal02.addEventListener("click", () => {
    ventanaModal02.style.display = "block";
});

cerrarModal02.addEventListener("click", () =>{
    ventanaModal02.style.display = "none";
});

window.addEventListener("click", (event) =>{
    if(event.target === ventanaModal02){
        ventanaModal02.style.display = "none";    
    }
...
//--------------------------------modal dentro de card3---------------------------------------------------------//



const ventanaModal03 = document.getElementById("ventanaModal03");
const botonAbrirModal03 = document.getElementById("botonAbrirModal03");
const cerrarModal03 = document.getElementById("cerrarModal03");

botonAbrirModal03.addEventListener("click", () => {
    ventanaModal03.style.display = "block";
});

cerrarModal03.addEventListener("click", () =>{
    ventanaModal03.style.display = "none";
});

window.addEventListener("click", (event) =>{
    if(event.target === ventanaModal03){
        ventanaModal03.style.display = "none";    
    }
...
//--------------------------------modal dentro de card4---------------------------------------------------------//



const ventanaModal04 = document.getElementById("ventanaModal04");
const botonAbrirModal04 = document.getElementById("botonAbrirModal04");
const cerrarModal04 = document.getElementById("cerrarModal04");

botonAbrirModal04.addEventListener("click", () => {
    ventanaModal04.style.display = "block";
});

cerrarModal04.addEventListener("click", () =>{
    ventanaModal04.style.display = "none";
});

window.addEventListener("click", (event) =>{
    if(event.target === ventanaModal04){
        ventanaModal04.style.display = "none";    
    }
